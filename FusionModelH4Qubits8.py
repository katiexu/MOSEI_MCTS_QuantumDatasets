...
# load molecular datasets (H4: 8 qubits)
H4datasets = qml.data.load("qchem", molname="H4", basis="STO-3G", bondlength=0.5)
H4data = H4datasets[0]
hamiltonian = H4data.hamiltonian
print("molecular dataset used: {}".format(H4data))
