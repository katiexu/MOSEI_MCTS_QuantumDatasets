...
# load molecular datasets (H3+: 6 qubits)
H3datasets = qml.data.load("qchem", molname="H3+", basis="STO-3G", bondlength=0.5)
H3data = H3datasets[0]
hamiltonian = H3data.hamiltonian
print("molecular dataset used: {}".format(H3data))
