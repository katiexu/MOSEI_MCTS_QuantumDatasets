...
# load molecular datasets (LiH: 12 qubits)
LiHdatasets = qml.data.load("qchem", molname="LiH", basis="STO-3G", bondlength=0.9)
LiHdata = LiHdatasets[0]
hamiltonian = LiHdata.hamiltonian
print(LiHdata.molecule)
print("molecular dataset used: {}".format(LiHdata))
...
if __name__ == '__main__':
    net = [0, 1, 0, 1, 1, 0, 0, 0, 1, 0, 0, 1, 2, 5, 11, 10, 1, 2, 9, 8, 3, 3, 7, 6]
