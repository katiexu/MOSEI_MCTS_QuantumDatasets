...
# load molecular datasets (H2: 8 qubits)
H2datasets = qml.data.load("qchem", molname="H2", basis="6-31G", bondlength=0.5)
H2data = H2datasets[0]
hamiltonian = H2data.hamiltonian
print("molecular dataset used: {}".format(H2data))
