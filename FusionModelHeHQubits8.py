...
# load molecular datasets (HeH+: 8 qubits)
HeHdatasets = qml.data.load("qchem", molname="HeH+", basis="6-31G", bondlength=0.5)
HeHdata = HeHdatasets[0]
hamiltonian = HeHdata.hamiltonian
print("molecular dataset used: {}".format(HeHdata))
