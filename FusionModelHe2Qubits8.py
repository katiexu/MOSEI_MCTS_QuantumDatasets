...
# load molecular datasets (He2: 8 qubits)
He2datasets = qml.data.load("qchem", molname="He2", basis="6-31G", bondlength=0.5)
He2data = He2datasets[0]
hamiltonian = He2data.hamiltonian
print("molecular dataset used: {}".format(He2data))
...
if __name__ == '__main__':
    net = [0, 1, 0, 1, 1, 0, 0, 0, 2, 5, 1, 2, 3, 3, 7, 6]
